...
Registry: `registry/micronauts.registry.json`. Fold definitions are maintained by the runtime; no `micronaut/micronaut.registry.xjson` exists in this repository.

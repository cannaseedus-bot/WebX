...
SemanticAgenticModel|How to define a declarative agent model that combines kernel functions, OpenAPI, code interpreter, file search, and DuckDuckGo-backed web search in one manifest.
